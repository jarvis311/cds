...
const CategoriesAdd = () => {
    ...
    const Save = async () => {
        if (Data.name === "" || Data.image === "" || Data.image === undefined || Data.image === null) {
            setValidate(true)
        } else {
            setValidate(false)
            Setloading(true)
                        ...
                        <Card.Body>
                            ...
                            <Row>
                                <Col md={6}>
                                    ...
                                    <Form.Control type="text" name="name" className="my-2" onChange={(e) => { InputData(e) }} required />
                                ...
                                <Col md={6}>
                                    ...
                                    <Form.Control type="file" name="image" className="my-2" onChange={(e) => { InputFile(e) }} required />
                                    <Form.Control.Feedback type="invalid">
